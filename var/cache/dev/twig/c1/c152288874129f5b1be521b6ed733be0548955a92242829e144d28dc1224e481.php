...
class __TwigTemplate_55dd97d50c51717ce71e267fb272dfa9fd2594632490d2d63a53d325369f630b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <p>On a surement du mal vous renseigner ! Aucun soucis,
        vous pouvez retourner a l'acceuil ou voir nos dernieres annonce !
        </p>
...
{% block title %}Page non trouvee{% endblock %}
...
{% block body %}
    <div class=\"container\">
        ...
        <a href=\"{{ path('homepage') }}\" class=\"btn btn-primary\">Retour a l'acceuil</a>
        <a href=\"{{ path('ads_index') }}\" class=\"btn btn-success\">Nos annonces</a>
    </div>
{% endblock %}", "@Twig/Exception/error404.html.twig", "C:\\xampp\\htdocs\\symbnb\\templates\\bundles\\TwigBundle\\Exception\\error404.html.twig");
    }
}
