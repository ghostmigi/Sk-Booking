...
class __TwigTemplate_8b9b0246669647cafc5a3aafb6f6e1abb25ee4f94e09b18f8010a5e7700de213 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <h1 class=\"my-4\">Modification du commentaire n° : ";
        // line 7
        ...
        <div class=\"alert alert-info\">
            <strong>Annonce liee : </strong> ";
        // line 10
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["comment"]) || array_key_exists("comment", $context) ? $context["comment"] : (function () { throw new RuntimeError('Variable "comment" does not exist.', 10, $this->source); })()), "ad", [], "any", false, false, false, 10), "title", [], "any", false, false, false, 10), "html", null, true);
        echo "<br>
            <strong>Auteur : </strong> ";
        // line 11
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["comment"]) || array_key_exists("comment", $context) ? $context["comment"] : (function () { throw new RuntimeError('Variable "comment" does not exist.', 11, $this->source); })()), "author", [], "any", false, false, false, 11), "fullName", [], "any", false, false, false, 11), "html", null, true);
        echo "<br>
        ...
        // line 13
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["comment"]) || array_key_exists("comment", $context) ? $context["comment"] : (function () { throw new RuntimeError('Variable "comment" does not exist.', 13, $this->source); })()), "rating", [], "any", false, false, false, 13), "html", null, true);
        echo "
        </div>
        ";
        // line 15
...
";
    ...
    {
        return array (  127 => 21,  119 => 16,  115 => 15,  110 => 13,  106 => 12,  102 => 11,  98 => 10,  92 => 7,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"container\">
        <h1 class=\"my-4\">Modification du commentaire n° : {{ comment.id }}</h1>

        <div class=\"alert alert-info\">
            <strong>Annonce liee : </strong> {{ comment.ad.title }}<br>
            <strong>Auteur : </strong> {{ comment.author.fullName }}<br>
            <strong>Date de creation : </strong> {{ comment.createdAt | date('d/m/Y H:i') }}<br>
            <strong>Note donnee : </strong> {{ comment.rating }}
        </div>
        {{ form_start(form) }}
        {{ form_widget(form) }}
        <button type=\"submit\" class=\"btn btn-primary\">
...
{% endblock %}", "admin/comment/edit.html.twig", "C:\\xampp\\htdocs\\symbnb\\templates\\admin\\comment\\edit.html.twig");
    }
}
