 ...
 */
final class Version20200403164342 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ad CHANGE content content LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
