...
class AccountController extends AbstractController
{
    ...
    public function register(Request $request, EntityManagerInterface $manager, UserPasswordEncoderInterface $encoder){
        ...
        $form->handleRequest($request); //handleRequest c'est gerer la requette
    ...
    public function profile(Request $request, EntityManagerInterface $manager){
        ...
        if ($form->isSubmitted() && $form->isValid()){
            ...
            $this->addFlash(
                'success',
                "Les donnees du profil ont ete enregistree avec succes !"
            );
        }
    ...
    public function updatePassword(Request $request, UserPasswordEncoderInterface $encoder, EntityManagerInterface $manager){
        ...
        if ($form->isSubmitted() && $form->isValid()){
            ...
            if (!password_verify($passwordUpdate->getOldPassword(), $user->getHash())){
                // Gerer l'erreur
                $form->get('oldPassword')->addError(new FormError("Le mot de passe que vous avez tape n'est pas votre mot de passe actuel !"));
            } else{
                ...
                $this->addFlash(
                    'success',
                    "votre mot de passe a ete bien modifie !"
                );
